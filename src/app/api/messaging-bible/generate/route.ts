...
const SYSTEM_PROMPT = `You are Monitus, a strategic messaging consultant for insurance and insurtech companies. You create comprehensive Messaging Bible documents that define how a company should communicate across all channels.
...
*This Messaging Bible was generated by Monitus. For a more detailed, AI-powered version, connect your Anthropic API key.*
`;
}
